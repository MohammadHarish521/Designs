import { AudioWaveform, Cpu, Database, Globe } from 'lucide-react';
      ...
      <div className="w-full flex justify-center relative h-12 bg-neutral-50 dark:bg-neutral-950 overflow-visible z-0">
        ...
        >
          ...
          <path
            d="M 300 -50 V 20 Q 300 50 200 50 H 100 Q 0 50 0 80 V 100"
            stroke="currentColor"
            className="text-amber-400 dark:text-amber-300 beam-travel"
            strokeWidth="1.5"
            fill="none"
            vectorEffect="non-scaling-stroke"
          ></path>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
            ...
            <div className="md:col-span-2 bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-8 relative overflow-hidden group">
              <div className="relative z-10">
                <div className="w-10 h-10 bg-amber-100 dark:bg-amber-400/10 rounded-lg flex items-center justify-center mb-6 text-neutral-900 border border-amber-200/70">
              ...
              {/* Visual: Limit Mockup */}
              <div className="absolute top-1/2 right-[-50px] md:right-0 w-[400px] h-[400px] bg-amber-50 dark:bg-neutral-800 rounded-l-2xl border-t border-l border-amber-100 dark:border-neutral-700 shadow-sm opacity-70 md:opacity-100 transition-transform group-hover:scale-[1.02] duration-500">
                <svg
                  width="100%"
                  height="100%"
            ...
            <div className="md:col-span-1 bg-neutral-900 dark:bg-neutral-800 rounded-2xl p-8 relative overflow-hidden flex flex-col justify-between text-white border border-transparent dark:border-neutral-700">
              ...
              {/* Code Snippet Visual */}
              <div className="mt-8 font-mono text-[10px] text-neutral-300 bg-neutral-800/50 dark:bg-neutral-900/50 p-4 rounded-lg border border-neutral-700/50">
            ...
            <div className="md:col-span-1 bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 p-8 group hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
              <div className="w-10 h-10 bg-amber-100 dark:bg-amber-400/10 rounded-lg flex items-center justify-center mb-6 text-neutral-900 dark:text-white border border-amber-200/70">
                <AudioWaveform size={20} strokeWidth={1.5} />
              </div>
            ...
            <div className="md:col-span-1 bg-[#FFFDF2] dark:bg-neutral-800 rounded-2xl border border-amber-100 dark:border-neutral-700 p-8 flex flex-col justify-center items-center text-center">
              <h3 className="text-lg font-semibold tracking-tight text-neutral-900 dark:text-white mb-2">
                Multi-Tenant Orgs
              </h3>
